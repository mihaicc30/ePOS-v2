  ...
  return (
    <div className="basis-[80%] bg-[--c60] z-10 overflow-y-scroll p-4 flex flex-col">
      ...
      <div className="flex flex-col gap-2 border-b-2 pb-4 my-4">
        ...
        <button className="mr-auto bg-[--c1] rounded px-3 py-1 font-bold border-b-2 border-b-[--c2] text-[--c2] relative inline-block shadow-xl active:shadow-black active:shadow-inner disabled:bg-[#cecdcd] disabled:text-[#ffffff] disabled:active:shadow-none">Update</button>
      </div>
      <div className="flex flex-col gap-2 border-b-2 pb-4 my-4">
        <p>Email:</p>
        <p>{user.email}</p>
