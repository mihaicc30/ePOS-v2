...
const Payment = ({ lefty, basketDiscount, user, basketItems, setBasketItems, venueNtable, setVenueNtable }) => {
  ...
  return (
    <div className={`flex flex-nowrap ${lefty ? "flex-row-reverse" : ""} gap-2 h-[100%] w-[100%]`}>
