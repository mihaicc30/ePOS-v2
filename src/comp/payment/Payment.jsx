    ...
    if (type === "cash") {
      ...
      try {
        ...
        if (!response) {
          ...
          setStripeResponse(`Fail! Could not get stripe payment intent.`);
          setTimeout(() => {
            setStripeResponse(``);
          }, 1400);
        ...
        setChange(change);
        setStripeResponse(`Success! Payment of £${padInput} has been made. ${leftToPay > 0 ? `£${leftToPay} are left to pay.` : ``}`);
        setTimeout(() => {
          setStripeResponse(``);
        }, 1400);
        setIsCardPressed(false);
