          ...
          <div className={`h-[100%] bg-[--c30] ml-auto border-r-4 rounded shadow-xl shadow-[#0a0a0a] flex flex-col w-[80%] p-4 min-h-[80svh] relative justify-start border-2 border-[--c12] max-w-[650px]`}>
            ...
            <div className={`flex grow flex-col`}>
              ...
              <div className="keypad grid grid-cols-4 gap-4 my-4">
                ...
                <button name="si" onClick={checkPin} className="row-span-3 bg-[--c12] rounded py-4 font-bold text-lg text-black border-b-2 border-b-[--c2] relative inline-block shadow-xl active:shadow-black active:shadow-inner disabled:bg-[#cecdcd] disabled:text-[#ffffff] disabled:active:shadow-none">
                  SignIn
                </button>
