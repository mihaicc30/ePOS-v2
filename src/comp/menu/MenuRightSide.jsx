  ...
  return (
    <>
      <div className="relative flex  mr-4 items-center max-[350px]:flex-wrap  max-[350px]:justify-center">
        ...
        <button onClick={() => setSearchValue("")} className={`p-2 bg-[--c1] rounded-xl shadow-xl border-b-2 border-b-black transition-all cursor-pointer hover:scale-[0.98] active:scale-[0.90] active:shadow-[inset_0px_4px_2px_black]`}>
          Clear Filters
        </button>
      </div>
      ...
      <div className="grid grid-cols-3">
        ...
        {menuType === "Bar Snacks" && <p>show bar snacks</p>}
      </div>

      <div className="grid grid-cols-4 overflow-y-scroll">
        {dbmenuitems
          .filter((category) => menuType === "" || category.name.toLowerCase() === menuType.toLowerCase())
          .map((category, index) => {
