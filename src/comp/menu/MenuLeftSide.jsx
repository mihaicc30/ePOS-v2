            ...
            <div className="flex flex-col">
              {menuItem.name === "Line" ? (
                <div className={`flex basis-[100%] ${lefty ? "flex-row-reverse" : ""} justify-end items-center relative`}>
                  ...
                  {!menuItem.printed && <button className=" bg-red-300 p-1 text-xs h-[24px] w-[32px] rounded transition-all cursor-pointer hover:scale-[0.98] active:scale-[0.90] shadow-md" onClick={() => handleRemoveItem(menuItem)}>
                    ❌
                  </button> }
                </div>
              ) : (
